...
optional arguments:
  ...
  -m,--metrics                Metrics type to collect raw data, options. Separated by the comma.
                                ...
                                1. GPU Power (W), per GPU and per tile or device.
                                ...
                                8. GPU Energy Consumed (J), per tile or device. Device-level is the sum value of tiles for multi-tiles.
                                ...
                                10. GPU EU Array Stall (%), the normalized sum of all cycles on all EUs during which the EUs were stalled. Per tile. At least one thread is loaded, but the EU is stalled. Per tile or device. Device-level is the average value of tiles for multi-tiles.
                                ...
                                22. Compute engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
                                23. Render engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
                                24. Media decoder engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
                                25. Media encoder engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
                                26. Copy engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
                                27. Media enhancement engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
                                28. 3D engine utilizations (%), per tile or device. Device-level is the average value of tiles for multi-tiles.
