...
static const cyaml_schema_field_t device_core_fields[] = {
	CYAML_FIELD_UINT("Type", CYAML_FLAG_OPTIONAL, ze_device_properties_t, type),
	CYAML_FIELD_UINT("VendorId", CYAML_FLAG_OPTIONAL, ze_device_properties_t, vendorId),
	CYAML_FIELD_UINT("DeviceId", CYAML_FLAG_OPTIONAL, ze_device_properties_t, deviceId),
	CYAML_FIELD_UINT("Flags", CYAML_FLAG_OPTIONAL, ze_device_properties_t, flags),
	CYAML_FIELD_UINT("SubdeviceId", CYAML_FLAG_OPTIONAL, ze_device_properties_t, subdeviceId),
	CYAML_FIELD_UINT("CoreClockRate", CYAML_FLAG_OPTIONAL, ze_device_properties_t, coreClockRate),
	CYAML_FIELD_UINT("MaxMemAllocSize", CYAML_FLAG_OPTIONAL, ze_device_properties_t, maxMemAllocSize),
	CYAML_FIELD_UINT("MaxHardwareContexts", CYAML_FLAG_OPTIONAL, ze_device_properties_t, maxHardwareContexts),
	CYAML_FIELD_UINT("MaxCommandQueuePriority", CYAML_FLAG_OPTIONAL, ze_device_properties_t, maxCommandQueuePriority),
	CYAML_FIELD_UINT("NumThreadsPerEU", CYAML_FLAG_OPTIONAL, ze_device_properties_t, numThreadsPerEU),
	CYAML_FIELD_UINT("PhysicalEUSimdWidth", CYAML_FLAG_OPTIONAL, ze_device_properties_t, physicalEUSimdWidth),
	CYAML_FIELD_UINT("NumEUsPerSubslice", CYAML_FLAG_OPTIONAL, ze_device_properties_t, numEUsPerSubslice),
	CYAML_FIELD_UINT("NumSubslicesPerSlice", CYAML_FLAG_OPTIONAL, ze_device_properties_t, numSubslicesPerSlice),
	CYAML_FIELD_UINT("NumSlices", CYAML_FLAG_OPTIONAL, ze_device_properties_t, numSlices),
	CYAML_FIELD_UINT("TimerResolution", CYAML_FLAG_OPTIONAL, ze_device_properties_t, timerResolution),
	CYAML_FIELD_UINT("TimestampValidBits", CYAML_FLAG_OPTIONAL, ze_device_properties_t, timestampValidBits),
	CYAML_FIELD_UINT("KernelTimestampValidBits", CYAML_FLAG_OPTIONAL, ze_device_properties_t, kernelTimestampValidBits),
	CYAML_FIELD_STRING("Name", CYAML_FLAG_OPTIONAL, ze_device_properties_t, name, 0),
	CYAML_FIELD_IGNORE("Uuid", CYAML_FLAG_OPTIONAL),
	CYAML_FIELD_END};
static const cyaml_schema_field_t device_properties_fields[] = {
	CYAML_FIELD_MAPPING("Core", CYAML_FLAG_OPTIONAL, sysman_device_properties_info_t, base.core, device_core_fields),
