...
FIELD_ANNOTATIONS_OVERRIDE = {
    ...
    # zes_memory_vendor_info_ext_properties_t.length is derived from the parsed
    # VendorName string, i.e. not configured directly, so skip it.
    ("zes_memory_vendor_info_ext_properties_t", "length"): Annotations(ignore=True),
