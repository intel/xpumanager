...
static const cyaml_schema_field_t sysman_freq_fields[] = {
	...
	CYAML_FIELD_SEQUENCE_COUNT("AvailableClocks", SYSMAN_NULLABLE_PTR_FLAGS, sysman_freq_t, available_clocks,
							   available_clocks_count, &double_schema, 0, CYAML_UNLIMITED),
