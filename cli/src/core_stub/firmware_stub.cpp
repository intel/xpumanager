...
std::unique_ptr<nlohmann::json> LibCoreStub::runFirmwareFlash(int deviceId, unsigned int type, const std::string& filePath) {
    ...
    auto res = xpumRunFirmwareFlash(deviceId, &job);
