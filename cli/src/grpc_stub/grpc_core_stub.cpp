...
std::unique_ptr<nlohmann::json> GrpcCoreStub::getDeivceIdByBDF(const char* bdf, int *deviceId) {
    assert(this->stub != nullptr);
    //todo, the function is not implemented for the rpc stub    
    auto json = std::unique_ptr<nlohmann::json>(new nlohmann::json());
    return json;
}
...
std::string GrpcCoreStub::diagnosticResultEnumToString(DiagnosticsTaskResult result) {
    std::string ret;
    switch (result) {
...
std::string GrpcCoreStub::diagnosticTypeEnumToString(DiagnosticsComponentInfo_Type type, bool rawComponentTypeStr) {
    std::string ret;
    switch (type) {
...
std::string GrpcCoreStub::healthStatusEnumToString(HealthStatusType status) {
    std::string ret;
    switch (status) {
...
std::string GrpcCoreStub::healthTypeEnumToString(HealthType type) {
    std::string ret;
    switch (type) {
...
std::unique_ptr<nlohmann::json> GrpcCoreStub::getPolicyById(bool isDevice, int id) {
    assert(this->stub != nullptr);
    grpc::ClientContext context;
    XpumDeviceBasicInfoArray response;
    auto json = std::unique_ptr<nlohmann::json>(new nlohmann::json());
...
std::unique_ptr<nlohmann::json> GrpcCoreStub::setPolicy(bool isDevcie, int id, XpumPolicyData& policy) {
    assert(this->stub != nullptr);
    auto json = std::unique_ptr<nlohmann::json>(new nlohmann::json());
    grpc::ClientContext context;
...
std::unique_ptr<nlohmann::json> GrpcCoreStub::getPolicy(bool isDevcie, int id) {
    assert(this->stub != nullptr);
    auto json = std::unique_ptr<nlohmann::json>(new nlohmann::json());
    grpc::ClientContext context;
...
std::string GrpcCoreStub::schedulerModeEnumToString(XpumSchedulerMode mode) {
...
std::string GrpcCoreStub::standbyModeEnumToString(XpumStandbyMode mode) {
