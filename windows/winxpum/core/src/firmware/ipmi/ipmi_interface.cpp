...
bsmc_hal_t ipmi_hal = {
ipmi_hal.init = ipmi_init,
ipmi_hal.cmd = ipmi_cmd,
ipmi_hal.validate_res = ipmi_validate_res,
ipmi_hal.oem_req_init = ipmi_oem_req_init};
...
static int ipmi_cmd(bsmc_req *req, bsmc_res *res) {
    ...
    request_buf.addr = (unsigned char *)&request_addr;
    ...
    */
    ...
    if (int ee = ipmi_cmd_win(&request_buf, &request_addr, &response_buf)) {
        return NRV_IPMI_ERROR;
    }
