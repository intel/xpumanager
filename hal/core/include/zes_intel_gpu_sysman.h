...
typedef struct _zes_intel_pci_link_speed_downgrade_exp_properties_t
{
	...
	int32_t maxPciGenSupported; ///< [out] Returns the max supported PCIe generation of the device. -1 indicated the
...
ze_result_t ZE_APICALL zesIntelDevicePciLinkSpeedUpdateExp(
	...
	ze_bool_t
		downgradeUpgrade, ///< [in] boolean value to decide whether to perform PCIe downgrade(true) or upgrade(false)
