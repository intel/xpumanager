 ...
 *  @file lenovo_florence_redfish_amc_manager.h
 */
#pragma once
...
struct FlorenceRedfishHostInterface {
...
class FlorenceRedfishAmcManager : public RedfishAmcManager {
   public:
   ...
   private:
    ...
    FlorenceRedfishHostInterface hostInterface;
};
} // namespace xpum