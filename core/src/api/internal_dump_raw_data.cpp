...
std::vector<DumpTypeOption> dumpTypeOptions{
    ...
    {XPUM_DUMP_COMPUTE_XE_LINK_THROUGHPUT, DUMP_OPTION_FABRIC, XPUM_STATS_MAX, XPUM_ENGINE_TYPE_UNKNOWN, "", "Xe Link Throughput (kB/s)", "a list of tile-to-tile Xe Link throughput.", 1000},
    ...
    {XPUM_DUMP_COMPUTE_ENGINE_GROUP_UTILIZATION, DUMP_OPTION_STATS, XPUM_STATS_ENGINE_GROUP_COMPUTE_ALL_UTILIZATION, XPUM_ENGINE_TYPE_UNKNOWN, "XPUM_STATS_ENGINE_GROUP_COMPUTE_ALL_UTILIZATION", "Compute engine group utilizations (%)", "per tile."},
    {XPUM_DUMP_MEDIA_ENGINE_GROUP_UTILIZATION, DUMP_OPTION_STATS, XPUM_STATS_ENGINE_GROUP_MEDIA_ALL_UTILIZATION, XPUM_ENGINE_TYPE_UNKNOWN, "XPUM_STATS_ENGINE_GROUP_MEDIA_ALL_UTILIZATION", "Media engine group utilizations (%)", "per tile."},
    {XPUM_DUMP_COPY_ENGINE_GROUP_UTILIZATION, DUMP_OPTION_STATS, XPUM_STATS_ENGINE_GROUP_COPY_ALL_UTILIZATION, XPUM_ENGINE_TYPE_UNKNOWN, "XPUM_STATS_ENGINE_GROUP_COPY_ALL_UTILIZATION", "Copy engine group utilizations (%)", "per tile."},
};
