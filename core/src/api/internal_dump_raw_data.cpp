...
std::vector<DumpTypeOption> dumpTypeOptions{
    ...
    {XPUM_DUMP_FREQUENCY_THROTTLE_REASON_GPU, DUMP_OPTION_THROTTLE_REASON, XPUM_STATS_FREQUENCY_THROTTLE_REASON_GPU, XPUM_ENGINE_TYPE_UNKNOWN, "XPUM_STATS_FREQUENCY_THROTTLE_REASON_GPU", "Throttle reason for GPU frequency", "per tile."},
};
