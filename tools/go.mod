...
require (
	...
	github.com/losisin/helm-values-schema-json/v2 v2.3.1 // indirect
	...
	go.opentelemetry.io/collector/cmd/builder v0.142.0 // indirect
	go.opentelemetry.io/collector/cmd/mdatagen v0.143.0 // indirect
